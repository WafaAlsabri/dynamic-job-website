...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{URL::to('add_partners')}}" class="menu-link">
            <div>Add company</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="{{URL::to('show_partners')}}" class="menu-link">
            <div>Show Companies</div>
          </a>
        </li>
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{URL::to('add_ads')}}" class="menu-link">
            <div>Add Ads</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="{{URL::to('show_ads')}}" class="menu-link">
            <div>Show ads</div>
          </a>
        </li>
